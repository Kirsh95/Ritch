...
document.addEventListener('click', function(e) {
  const el = e.target.closest('.hot_home');
  if (el) {
...
class ItcSlider {
  ...
  constructor(el, config = {}, prefix = 'itc-slider-') {
    this.#state = {
      ...
      btnPlay: el.querySelector(`.${prefix}${this.constructor.#BTN_PLAY}`), // кнопка, для перехода к следующему слайду
  ...
  #onClick(e) {
    ...
    const classBtnPlay = this.#state.prefix + this.constructor.#BTN_PLAY;
    this.#autoplay('stop');
